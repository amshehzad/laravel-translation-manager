<div x-on:click.away="$wire.editing = false" style="position: relative">
    ...
    <div x-cloak x-show="$wire.editing" class="translation-editor card shadow p-2 mb-5 ">
        <div class="arrow"></div>
        <form class="d-flex" wire:submit.prevent="update">
            <input wire:model="value" type="text" class="form-control mr-2">
            <button class="btn btn-success mr-1" type="submit"><i class="fa fa-check"></i></button>
