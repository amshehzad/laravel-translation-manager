<div class="card mt-2">
    ...
    <div class="card-body">
        <fieldset>
            ...
            <p>{{ __('Current supported locales:') }}</p>
            ...
            <form class="form-add-locale" wire:submit.prevent="addLocale" aria-label="Add Locale">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-auto">
                            <input type="text" class="form-control @error('localeName') is-invalid @enderror" wire:model="localeName"/>
                            @error('localeName')
                        ...
                        <div class="col-auto">
                            <button type="submit" wire:click.prevent="addLocale" class="btn btn-block btn-outline-success">
